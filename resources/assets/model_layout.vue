...
<script>
import clear_header from "./components/model/layout/clear_header";
import left_side from "./components/model/layout/left-side";
import right_side from "./components/model/layout/right-side";
